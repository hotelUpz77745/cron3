            ...
            try:
                ...
                if "per_coin" in data:
                    ...
                    for sym, cdata in sorted(data["per_coin"].items()):
                        ...
                        lines.append(f"  DRME1 (Epochs): {cdata.get('DRME1', cdata.get('DRME', 0))} | DRME2 (Inc): {cdata.get('DRME2', cdata.get('DRME', 0))}")
                        lines.append(f"  MDME1 (Epochs): {cdata.get('MDME1', cdata.get('MDME', 0))} | MDME2 (Inc): {cdata.get('MDME2', cdata.get('MDME', 0))}\n")
            ...
            if analytics_path.exists():
                try:
                    ...
                    if "per_coin" in data and symbol in data["per_coin"]:
                        ...
                        msg_coins += f"  • DRME1 (Epochs): <b>{cdata.get('DRME1', cdata.get('DRME', 0))}</b> | DRME2 (Inc): <b>{cdata.get('DRME2', cdata.get('DRME', 0))}</b>\n"
                        msg_coins += f"  • MDME1 (Epochs): <b>{cdata.get('MDME1', cdata.get('MDME', 0))}</b> | MDME2 (Inc): <b>{cdata.get('MDME2', cdata.get('MDME', 0))}</b>\n\n"
