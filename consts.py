...
INCOME_PARSE_FREQ_SEC: float = float(_CFG["app"]["income_parse_freq_sec"])
ANALYTICS_SYNC_FREQ_SEC: float = float(_CFG["app"]["analytics_sync_freq_sec"])
REALTIME_DRAWDOWN_FREQ_SEC: float = float(_CFG["app"].get("realtime_drawdown_freq_sec", 15.0))
