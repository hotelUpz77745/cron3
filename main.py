...
#   ],
    ...
    # } -- добавшь секцию в конфиги а также внедришь механизм автоматического закрытия позиции. Это закрытие не имеет никакого отношения к остановке бота либо каких то пауз -- есть тригер Net профита -- закрываем позиции как если бы мы нажали кнопку Close All -- бот должен продалжать работу в штатном режиме включая подсос аналитики и так далее.
